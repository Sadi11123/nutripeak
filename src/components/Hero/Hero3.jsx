            ...
            <div className="max-w-md text-white">
              ...
              <div className="flex gap-3 pt-10">
                <motion.button
                  ...
                  className="text-lg font-medium text-black py-3 px-9 bg-white rounded-xl  hover:bg-black hover:text-white duration-500"
                >
                  Shop Now
                </motion.button>
                <motion.button
                  ...
                  transition={{ duration: 0.6 }}
                  className="text-lg font-medium text-white py-3 px-9 rounded-xl border border-white  hover:bg-black hover:text-white duration-500"
                >
                  View Product
                </motion.button>
              </div>
