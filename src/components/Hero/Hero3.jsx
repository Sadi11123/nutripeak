import HeroThree from "../../assets/Media/hero-img/Hero-Img-three.png";
...
const Hero3 = ({ activeSlide, index }) => {
  return (
    <div>
      <div className="bg-[#083D2A] min-h-screen flex items-center pt-49 overflow-hidden">
        <div className="max-w-375 mx-auto px-6 w-full relative">
          ...
          <div className="flex flex-col items-center relative">
            <motion.h1
              ...
              className="text-[96px] font-black text-[#1CE89F] uppercase text-center tracking-[-3px] leading-22.5"
            >
          ...
          <div className="absolute right-6 top-1/2 -translate-y-1/2 hidden lg:block mr-20 pt-24">
            <div className="max-w-md text-white">
              ...
              <div className="flex gap-3 pt-10">
                <button className="text-lg font-medium text-black py-3 px-9 bg-white rounded-xl  hover:bg-black hover:text-white duration-500">
                  Shop Now
                </button>
                <button className="text-lg font-medium text-white py-3 px-9 rounded-xl border border-white  hover:bg-black hover:text-white duration-500">
                  View Product
                </button>
              </div>
            </div>
