...
const Navbar = () => {
  return (
    ...
    <div className="w-full fixed mx-auto top-10 z-50">
      <div className="navbar w-full max-w-7xl rounded-2xl bg-black mx-auto text-white px-4">

        {/* LEFT: LOGO */}
        <div className="navbar-start">
          <NavLink to="/" className="text-2xl font-bold tracking-wide">
            Nutri<span className="text-white">Peak</span>
          </NavLink>
        </div>

        {/* CENTER: MENU */}
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 gap-6 font-medium text-lg py-8">
